# The Republic of Meuse

**Official name**: The Republic of Meuse (République de la Meuse)  
**Capital**: Liège  
**Head of Government**: Consul (elected by the Assembly)  
**Founded**: circa 1671, following Spanish withdrawal from the southern Netherlands
...
The Republic is defined by the Meuse river, which originates in France, runs north through Liège and Namur, and flows through Dutch-controlled Flanders before reaching the North Sea. This geography is both the Republic's commercial lifeline and its central vulnerability:
...
- Service in the civic militia

This is philosophically distinct from the English propertied franchise (*what you own*) and the Dutch regent oligarchy (*who you are*). The Republic of Meuse asks instead *what you do*. A master gunsmith with no land votes. A coalminers' foreman with no inherited status votes. A wealthy man who does nothing productive does not.

This makes the Republic's franchise the broadest of any Maritime League state in its early decades, and the most closely studied by republican thinkers across the continent.

### The Assembly

The franchise-qualified population elects the Assembly, which holds legislative authority and elects the Consul.
